...
class Experiment(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "organization_id", "project_id", "idempotency_key", name="uq_experiments_idempotency"
        ),
    ...
    status: Mapped[ExperimentStatus] = mapped_column(
        SqlEnum(
            ExperimentStatus, name="experiment_status", native_enum=False, create_constraint=True
        ),
        nullable=False,
...
class ExperimentRunItem(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    status: Mapped[ExperimentRunItemStatus] = mapped_column(
        SqlEnum(
            ExperimentRunItemStatus,
            name="experiment_run_item_status",
            native_enum=False,
            create_constraint=True,
        ),
        nullable=False,
